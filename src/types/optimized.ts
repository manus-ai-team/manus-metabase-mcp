...
/**
 * Type guard to check if response is an optimized card
 */
export function isOptimizedCard(response: OptimizedResponse): response is OptimizedCard {
  return 'database_id' in response && 'dataset_query' in response;
}

/**
 * Type guard to check if response is an optimized dashboard
 */
export function isOptimizedDashboard(response: OptimizedResponse): response is OptimizedDashboard {
  return 'dashcards' in response;
}

/**
 * Type guard to check if response is an optimized table
 */
export function isOptimizedTable(response: OptimizedResponse): response is OptimizedTable {
  return 'fields' in response && 'db_id' in response;
}

/**
 * Type guard to check if response is an optimized database
 */
export function isOptimizedDatabase(response: OptimizedResponse): response is OptimizedDatabase {
  return 'engine' in response && 'tables' in response;
}
...
/**
 * Type guard to check if response is an optimized field
 */
export function isOptimizedField(response: OptimizedResponse): response is OptimizedField {
  return 'database_type' in response && 'table_id' in response && 'table' in response;
}
